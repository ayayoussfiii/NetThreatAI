...
> Système  détection de menaces réseau en temps réel basé sur un ensemble de modèles Machine Learning (Random Forest + Isolation Forest + Autoencoder), déployable sur Kali Linux.
